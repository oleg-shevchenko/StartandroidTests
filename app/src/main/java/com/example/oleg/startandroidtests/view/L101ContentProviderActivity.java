...
public class L101ContentProviderActivity extends AppCompatActivity {

    final String LOG_TAG = "myLogs";

    final Uri CONTACT_URI = Uri.parse("content://com.example.oleg.startandroidtests.contentprovider.AdressBook/contacts");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l101_content_provider);
